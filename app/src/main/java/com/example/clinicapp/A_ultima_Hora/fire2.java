...
public class fire2 extends AppCompatActivity {
    ...
    public void creatingLayouts() {
        ...
        myAdapter = new UserAdapter3(this);
        updateAdapter();
    ...
    public void btnAddOnClick(View v) {
        ...
        User3 user = new User3(name, country, weight);
    ...
    public void updateDatabase(User3 user) {
    ...
    public void updateAdapter() {
        ...
        final List<User3> listUsers = new ArrayList<>();
        databaseReference.child("users").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                listUsers.add(dataSnapshot.getValue(User3.class));
    ...
    public void displayUsers(List<User3> ls) {
